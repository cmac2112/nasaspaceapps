    ...
    <Layout>
      <div className="bg">
        ...
        <ol className="parapraph1">
          <li>
            {" "}
            <i>1. Semi-major axis (a) </i>: Defines the size of the conic.
          </li>
          <li>
            {" "}
            <i>2. Eccentricity (e) </i>: Defines the shape of the conic.
          </li>
          <li>
            {" "}
            <i> 3. Inclination (i) </i>: The angle between the reference frame
            and the orbital plane.
          </li>
          <li>
            {" "}
            <i>4. Longitude of the ascending node (Ω) </i>: The pin.
          </li>
          <li>
            {" "}
            <i>5. Argument of periapsis (ω) </i>: The twist.
          </li>
          <li>
            {" "}
            <i>6. Mean anomaly at epoch (v) </i>: The angle.
          </li>
        </ol>
        ...
        <ul className="anomaly2">
          <li>
            <strong>
              The mean anomaly of the planet is given by this formula;{" "}
            </strong>
            <strong>M = n * d + L - p </strong>
          </li>
          <li>n - daily motion</li>{" "}
          <li> d - number of days since the date of the elements </li>
        ...
        <ul className="radius2">
          <li>
            ...
            a simple formula based on the geometry of the ellipse;
          </li>
          <strong>
            {" "}
            <i> r = a * (1 - e^2) / [1 + e * cos(v)] </i>
          </strong>
        </ul>
        ...
        <ul className="orbitalelements">
          <li>
            <strong>
              The positions of objects in the sky as viewed from Earth are
              referred to a coordinate system whose alignment is changing with
              time in a complex way. A few of the important motions and effects
              are;{" "}
            </strong>
          </li>
          <li>• The Earth is rotating on its axis once every siderial day.</li>
          <li>
            • The rotation axis is moving in a circle with a period of roughly
            26,000 years.
          </li>
          <li>
            • The axis is 'nodding' up and down with a period of roughly 19
            years.
          </li>
          <li>• The finite speed of light.</li>
        </ul>
        ...
        <ol className="helio">
          <strong>
            {" "}
            Heliocentric coordinates are a system of coordinates that measure
            the positions of objects in space relative to the center of the Sun.
            These coordinates are often used to describe the locations and
            movements of planets and other bodies within the Solar System.
          </strong>
          <li>
            Having found the true anomaly and the radius vector of the planet,
            we can go on to find the position of the planet with respect to the
        ...
        <ol className="ast">
          <li>
            ...
            where N,i,w are valid for a specific epoch (nowadays usually
            2000.0). In our simplified computational scheme, the only
            significant changes with the epoch occurs in N. To convert N_Epoch
            to the N (today's epoch) we want to use, simply add a correction for
            precession:
          </li>
        ...
        <p className="comets">
          {" "}
          Position of <del>asteroids</del> <ins>comets</ins>{" "}
        </p>
        <ol className="comet">
          <li>
            For comets with elliptical orbits, the mean anomaly (M) is typically
            not provided. Instead, the time of perihelion (T) is given. At
            perihelion, M is zero. To calculate M for any other time, follow
            these steps:
          </li>
          <li>
            {" "}
            1. Compute the “day number” (d) for the time of perihelion (T),
            which we’ll call dT.
          </li>
          <li>
            {" "}
            2. Compute the “day number” (d) for the moment you want to determine
            the position.
          </li>
          <li>Then, calculate the mean anomaly (M) using the formula: </li>
          <img src={kep8} alt="Description" class="styled-image" />
          <li>
            Additionally, the semi-major axis (a) is often not provided.
            Instead, the perihelion distance (q) is given. You can compute a
            from q and the <i>eccentricity (e)</i> using the formula:
          </li>
          <i>a = q / (1.0 - e)</i>{" "}
          <li>
